...
class DeleteAccountStudent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_delete_account_student)
    ...
    private fun deleteUserCollections(email: String) {
        ...
        batch.commit().addOnCompleteListener { batchTask ->
            if (batchTask.isSuccessful) {
                ...
                // Redirect to welcome screen or another activity as needed
