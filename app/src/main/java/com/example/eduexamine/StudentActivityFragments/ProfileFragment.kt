...
class ProfileFragment : Fragment() {
    ...
    private fun setupButtons(view: View) {
        ...
        buttonEducationalDetails.setOnClickListener { val intent=Intent(requireContext(),
            EducationalDetails::class.java)
            startActivity(intent) }
        buttonBasicInformation.setOnClickListener { val intent=Intent(requireContext(),
            BasicInfoStudent::class.java)
            startActivity(intent) }
        buttonAccountSetting.setOnClickListener { val intent=Intent(requireContext(),
            AccountSettingStudent::class.java)
            startActivity(intent) }
        buttonAcademicCareerInfo.setOnClickListener { val intent=Intent(requireContext(),
            AcademicInfoStudent::class.java)
            startActivity(intent) }
        buttonSocialContactLinks.setOnClickListener { val intent=Intent(requireContext(),
            SocialStudents::class.java)
            startActivity(intent) }
